...
function sessionCookie(token){return `rmaquest_session=${encodeURIComponent(token)}; Path=/; HttpOnly; SameSite=Lax; Secure; Max-Age=${60*60*24*7}`;}
function clearSessionCookie(){return 'rmaquest_session=; Path=/; HttpOnly; SameSite=Lax; Secure; Max-Age=0';}
